        ...
        <div class="col-sm-4 galleryMediaFile">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a class="zoom" href="<?php echo $media->getUrl(); ?>#.jpeg" data-type="image" data-toggle="lightbox" data-parent="#gallery-content"  data-gallery="GalleryModule-Gallery-<?php echo $gallery->id; ?>" data-ui-gallery="GalleryModule-Gallery-<?php echo $gallery->id; ?>"
