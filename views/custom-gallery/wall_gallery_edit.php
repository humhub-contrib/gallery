...
<div class="content_edit" id="gallery_edit_gallery_<?php echo $gallery->id; ?>">
    ...
    <div id="gallery_gallery_description_<?php echo $gallery->id; ?>_contenteditable" class="form-control atwho-input"
         contenteditable="true"><?php echo RichText::widget(['text' => $gallery->description, 'edit' => true]); ?></div>
         ...
         <?= RichTextEditor::widget(['id' => 'gallery_gallery_description_' . $gallery->id, 'inputContent' => $gallery->description, 'record' => $gallery]); ?>
    ...
    echo AjaxButton::widget([
        ...
        'ajaxOptions' => [
            ...
            'success' => new JsExpression('function(html){$(".wall_' . $gallery->getUniqueId() . '").replaceWith(html); }'),
