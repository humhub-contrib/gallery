    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">
                <?php echo Yii::t('GalleryModule.base', '<strong>Move</strong> files'); ?>
            </h4>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="directory-list">
                <div class="selectable" id="0"><?php echo Yii::t('GalleryModule.base', '/ (root)'); ?></div>
                <ul>
                <?php
            ...
            <button type="button" class="btn btn-primary"
                    data-dismiss="modal"><?php echo Yii::t('GalleryModule.base', 'Close'); ?></button>
