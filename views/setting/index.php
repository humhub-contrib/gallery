    ...
    <div class="panel-body">
        ...
        <?php if($settings->hasGallery()) : ?>
            <?php $form = ActiveForm::begin() ?>
                ...
                <?= $form->field($settings, 'sortOrder')->textInput(['type' => 'number', 'placeholder' => Yii::t('GalleryModule.base', 'from ' . $settings::SORT_MIN . ' to ' . $settings::SORT_MAX . ' in increments of 100'),]) ?>
