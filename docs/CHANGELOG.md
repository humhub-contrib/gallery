...
1.9.0 (Unreleased)
------------------
- Enh: Send a single notification to announce all media files uploaded within a short period of time, rather than sending one notification per file (humhub/humhub#5334)
