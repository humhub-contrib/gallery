...
return [
  ...
  '<strong>Gallery</strong> module configuration' => 'Configuración del módulo <strong>Galería</strong>',
  '<strong>Gallery</strong> of posted media files' => '<strong>Galería</strong> de archivos enviados',
  '<strong>Gallery</strong> settings' => 'Ajustes de <strong>Galería</strong>',
  '<strong>Gallery</strong> {title}' => '<strong>Galería</strong> {title}',
