...
return array (
  ...
  '<strong>Confirm</strong> delete gallery' => '<strong>Bekreft</strong> sletting av bilde galleri',
  ...
  '<strong>Gallery</strong> settings' => '<strong>Bildegalleri</strong> innstillinger',
